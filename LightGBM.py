...
pyplot.scatter(yhat_test,y_test, marker='o',facecolor='lightseagreen',edgecolor='lightseagreen', label=r'$\mathbf{LightGBM\hspace{0.5em}K_s=300\hspace{0.5em}}$')
#pyplot.scatter(yhat_test,y_test, marker='o',facecolor='blue',edgecolor='blue', label=r'$XGBoost\hspace{0.5em}K_s=300\hspace{0.5em}$')
...
pyplot.plot(xk,ykPlus10Perc, dashes=[2,2], color='lightseagreen')
pyplot.plot(xk,ykMinus10Perc,dashes=[2,2], color='lightseagreen')
pyplot.grid(True)
