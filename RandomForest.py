...
pyplot.scatter(yhat_test,y_test, marker='o',facecolor='forestgreen',edgecolor='forestgreen', label=r'$\mathbf{Random\hspace{0.5em}Forest \hspace{0.5em}K_s=300}$')
...
pyplot.plot(xk,ykPlus10Perc, dashes=[2,2], color='forestgreen')
pyplot.plot(xk,ykMinus10Perc,dashes=[2,2], color='forestgreen')
pyplot.grid(True)
